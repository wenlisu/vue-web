        ...
        <div class="page-container bgc-f5">
            ...
            <div class="mt-10 bgc-fff clearfix">
                <div class="materialclasses bk-gray radius bgc-fff f-l">
                    <div class="materialsTop"><a class="btn btn-primary radius mr-5" href="javascript:;" v-on:click="clickAddClass()"><i class="Hui-iconfont">&#xe600;</i>添加材料类型</a></div>
                ...
                <div class="materials bk-gray radius bgc-fff">
                    <div class="pt-10 pb-10 clearfix"><a class="btn btn-primary radius mr-5 f-r" href="javascript:;" v-on:click="clickAdd()"><i class="Hui-iconfont">&#xe600;</i>添加材料</a></div>
    ...
    export default{
        ...
        methods: {
            ...
            clickImport:function(){
                ...
                this.importData.importUrl = base.gAjaxUrl.materialsImport;
                this.importData.templateUrl = 'http://eqixing.oss-cn-shenzhen.aliyuncs.com/materials_import.xlsx';
            },
            //初始化分页
            ...
            getList:function(reset=0){
                ...
                this.queryAjax((tpageToal='4')=>{
                    that.initPage('#J-page',tpageToal,materialOps.param.page)
                });
            },
