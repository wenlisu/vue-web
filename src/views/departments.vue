<template>
    ...
    <div class="page-container">
        <div class="text-l clearfix">
            <input v-model="searchInput" type="text"  placeholder="部门" style="width:250px" class="f-l input-text">
        ...
        <table class="table table-border table-bordered table-hover table-bg">
            <thead>
                <!-- <tr>
                    <th scope="col" colspan="10">部门管理</th>
                </tr> -->
                <tr class="text-c">
    ...
    export default{
        ...
        methods: {
            ...
            getList:function(reset=0){
                ...
                this.queryAjax((tpageToal='4')=>{
                    this.initPage('#J-page',tpageToal,departmentsOps.param.page);
                });
            },
            //删除
