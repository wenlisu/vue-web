<template>
    <!-- 添加 -->
    <add :title="dialogTitle" :type="dialogType" :data="dialogData" v-if="isShowAddDialog" v-on:dialog-close="addDialogClose" v-on:dialog-save="addDialogSave" v-on:dialog-saveAndAdd="addDialogSaveAndAdd"></add>
        ...
        <div class="page-container bgc-f5">
            ...
            <div class="bk-gray radius mt-10 bgc-fff">
                <div class="pd-10 clearfix bor-b">
                    <span class="f-r">
                        <a class="btn btn-primary radius mr-5" title="编辑" href="javascript:;" v-on:click="clickModify()"><i class="Hui-iconfont">&#xe6df;</i>编辑</a>
                        <a class="btn btn-primary radius mr-5 ml-5" title="删除" href="javascript:;" v-on:click="clickDelete()"><i class="Hui-iconfont">&#xe6e2;</i>删除</a>
                    </span>
                </div>
