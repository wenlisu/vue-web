<template>
    <div id="move" class="move layui-layer layui-anim layui-layer-page layui-modify layui-modify1" draggable="true">
                ...
                <div class="f-l div-bottom mt-5" style="height: 57.5%;width: 100%;">
                    <div class="text-c f-22">
                        <div class="text-c layui-layer-title layui-layer-title-bottom  f-24">
                            ...
                            <div id="order_hange" class="f-l f-24 div-bold">当天待派单的订单总数为:</div>
...
<script>
    ...
    export default{
        ready () {
            ...
            var arraychange = ["当天待派单中的订单总数为:","当天行程中的订单总数为:","当天已完成的订单总数为:","当天已取消的订单总数为:"];
            var arraychangecolor = ['#e64179','#3494f1','#3abfa5','#7e4fff'];
            var orderStatusArray = [20,50,60,-10];
            var j = 0;
            // 动态传值进行调用数据显示在表格
