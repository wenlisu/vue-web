...
<script>
    ...
    export default{
        ready () {
            ...
            this.driverQueryAjax((tpageToal='4')=>{
                this.driverInitDPage('#J-driver-page',tpageToal)
            });      

            this.carQueryAjax((tpageToal='4')=>{
                this.carInitDPage('#J-car-page',tpageToal)
            });   
        ...
        methods: {
            ...
            driverInitDPage:function(obj,tpageToal='4',current='1'){
                $(obj).createPage({
                    pageCount:tpageToal,
                    current:current,
                    callback:(p)=>{
            ...
            carInitDPage:function(obj,tpageToal='4',current='1'){
                $(obj).createPage({
                    pageCount:tpageToal,
                    current:current,
                    callback:(p)=>{
