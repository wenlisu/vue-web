<template>
    ...
    <div class="page-container">
        ...
        <div class="text-l mt-20"> 
            关键字：
            <input type="text" class="input-text Wdate mr-5" style="width:150px;" placeholder="站点/出发时间" v-model="searchInput">
            ...
            <table class="table table-border table-bordered table-hover table-bg mt-20" >
                ...
                <tbody>
                    <tr class="text-c" v-for="item in items">
                        ...
                        <td>
                            <a class="btn btn-link size-S radius" href="javascript:;" v-on:click="clickCheck(item)">查看路径</a>
                        </td>
                    </tr>
                </tbody>
                </div>
