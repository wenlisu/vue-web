            ...
            <table class="table table-border table-bordered table-hover table-bg table-sort mt-20">
                ...
                <tbody v-if="!noData">
                    <tr class="text-c" v-for="item in items">
                        ...
                        <td>{{item.shuttle_bus_vo['stations_json']['0']['station_name']}}</td>
                        <td>{{item.shuttle_bus_vo['stations_json'][item.shuttle_bus_vo['stations_json'].length-1]['station_name']}}</td>
        ...
        methods: {
            ...
            getList:function(reset=0){
                ...
                this.queryAjax((tpageToal='4')=>{
                    ...
                    this.initPage('#J-page',saleableOps.param.page)
                });
            }
        },
        components:{
