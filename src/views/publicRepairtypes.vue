            ...
            <div class="bk-gray radius mt-10 bgc-fff">
                <div class="pd-15 clearfix">
                    ...
                    <div class="text-l clearfix f-l mr-15">
                        <input v-model="searchInput" type="text"  placeholder="报修类型" style="width:250px" class="f-l input-text">
                        <button v-on:click="getList(1)" class="btn btn-success" type="button"><i class="f-r Hui-iconfont">&#xe665;</i></button>
                    </div>
                    <span class="f-r">
                        <a class="btn btn-primary radius mr-5" href="javascript:;" v-link="{ name: 'setDormitoryApprovers' }" data-title="设置审批人"> 设置审批人</a>
                    </span>
                </div>
