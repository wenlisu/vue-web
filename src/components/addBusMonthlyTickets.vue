                ...
                <div id="fitbus" v-show="fitbus">
                    <div id="row cl" class="row cl">
                        ...
                        <div id="ticketNameInputid" class="formControls f-l col-4">
                            <input  v-model="ticketNameInput" type="text" class="input-text" value="" placeholder="" name="ticket_name">
                        </div>
                    </div> 
                    <div class="row cl">
                    ...
                    <div class="row cl">
                        <label class="form-label f-l col-4 "><span class="c-red">*</span>说明：</label>
                        <div class="formControls f-l col-4">
                            <textarea v-model="ticketDescpInput" class="input-text area-text" value="" placeholder="" name="ticket_descp"></textarea>
                        </div>
                    </div>
                </div>
                <div class="row cl">
                    ...
                    <div class="formControls f-l col-7">
                        <div class="m-multiple-select clearfix">
                            <div id="area-l" class="area-l">
                                <div class="bd">  
                                    <a v-if="selectedBusItems.indexOf(item.id)<0" v-bind:class="[addItemTemp.indexOf(item.id)>-1 ? 'active' : '']" v-bind:data-id="item.id" v-for="item in busItems" href="javascript:;" v-on:click="clickAddItemTemp(item.id)">{{item.shuttle_name}}</a>
                                </div>
                            </div>
                            ...
                            <div id="area-r" class="area-r">
                                <div class="bd">
                                    <a v-if="selectedBusItems.indexOf(item.id)>=0" v-bind:class="[deleteItemTemp.indexOf(item.id)>-1 ? 'active' : '']" v-bind:data-id="item.id" v-for="item in busItems" href="javascript:;" v-on:click="clickDeleteItemTemp(item.id)">{{item.shuttle_name}}</a>
                                </div>
                            </div>
                        </div>
                    </div>
