<template>
    <div class="layui-layer layui-anim layui-layer-page layui-modify layui-modify-left">
        <div class="layui-layer-title layui-layer-title-combine layui-layer-title-two">
    ...
    export default{
        ...
        methods: {
            ...
            queryAjax:function(callback=function(){}){
                ...
                $.ajax({
                    url: `${base.gAjaxUrl.officialcarorders}${that.topItems['id']}/can_carpool_orders/?page=${carpoolOps.page}&page_size=${carpoolOps.page_size}`,
            ...
            save:function(){
                ...
                // });
                $.ajax({
                    url: `${base.gAjaxUrl.officialcarorders}${this.topItems['id']}/combine/`,
                    contentType: 'application/json',
                    type: 'POST',
