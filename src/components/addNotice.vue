                ...
                <div class="row cl" v-if="targetSelected == 'DEPARTMENT'">
                    ...
                    <div class="formControls f-l col-7">
                        <div class="m-multiple-select clearfix">
                            <div class="area-l">
                                <div class="bd">  
                                    <a v-if="selectedItems.indexOf(item.id)<0" v-bind:class="[addItemTemp.indexOf(item.id)>-1 ? 'active' : '']" v-bind:data-id="item.id" v-for="item in departmentItems" href="javascript:;" v-on:click="clickAddItemTemp(item.id)">{{item.department_name}}</a>
                                </div>
                            </div>
                            <div class="s-btn">
                            ...
                            <div class="area-r">
                                <div class="bd">
                                    <a v-if="selectedItems.indexOf(item.id)>=0" v-bind:class="[deleteItemTemp.indexOf(item.id)>-1 ? 'active' : '']" v-bind:data-id="item.id" v-for="item in departmentItems" href="javascript:;" v-on:click="clickDeleteItemTemp(item.id)">{{item.department_name}}</a>
                                </div>
                            </div>
                        </div>
                    </div>
